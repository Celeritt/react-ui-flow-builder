...
const DatahubContent: React.FC<DatahubContentProps> = ({ activePage }) => {
  ...
  const renderCloudContent = () => {
    if (activePage === 'datahub-connectors') {
      return (
        <div>
          <h2 className="text-xl font-semibold mb-4">HutchDB</h2>
    ...
    } else if (activePage === 'datahub-s3') {
      return (
        <div>
          <h2 className="text-xl font-semibold mb-4">AWS S3</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-6">
    ...
    } else if (activePage === 'datahub-azure') {
      return (
        <div>
          <h2 className="text-xl font-semibold mb-4">Azure Blob/ADLS</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-6">
    ...
    } else if (activePage === 'datahub-gcp') {
      return (
        <div>
          <h2 className="text-xl font-semibold mb-4">Google Cloud Storage</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-6">
    ...
    } else if (activePage === 'datahub-upload') {
      return (
        <div>
    ...
    return (
      <div className="text-center p-12">
        <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-300">Select a data source from the sidebar</h2>
        <p className="text-gray-500 dark:text-gray-400 mt-2">Choose a cloud provider or storage option to begin</p>
      </div>
    );
  };
